...
import discriminators from '../../../assets/symptoms_01_exercise_vs_infection_discriminators.png';
import discriminatorsDark from '../../../assets/symptoms_01_exercise_vs_infection_discriminators_dark.png';
import algorithmA from '../../../assets/symptoms_02_acute_symptom_algorithm.png';
import algorithmADark from '../../../assets/symptoms_02_acute_symptom_algorithm_dark.png';
...
<Note>
**Learning objectives:**
- Exercise-induced and infection-based stress across the seven framework dimensions
- Symptom vs sign, and the "neck check" heuristic
- The temporal pattern as the decisive discriminator, with PEM as a red flag
</Note>
...
<Figure src={discriminators} srcDark={discriminatorsDark} alt="The eight signs ordered by discriminating power">
...
<Note>
**Learning objectives:**
- Symptom and load instruments: WURSS, DALDA, TQR, session-RPE, POMS
- The five-domain physical examination and the red flags in each
- The tiered laboratory ladder (Level 1–3) and its escalation logic
</Note>
...
<Note>
**Learning objectives:**
- Algorithm A (acute symptom onset) and Algorithm B (return-to-sport clearance)
- Three principles for reading trace elements in the post-exercise setting
- The standardised evaluation checklist and the actions its thresholds trigger
</Note>

### 3.1 Algorithm A: Acute Symptom Onset in Athletes

<Figure src={algorithmA} srcDark={algorithmADark} alt="Algorithm A — acute symptom onset in athletes">
