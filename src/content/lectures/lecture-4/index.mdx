...
import fig1 from '../../../assets/acuteresponse_01_gk97_biphasic_kinetics.png';
import fig1Dark from '../../../assets/acuteresponse_01_gk97_biphasic_kinetics_dark.png';
import fig2 from '../../../assets/acuteresponse_02_gab03_leukocytes.png';
import fig2Dark from '../../../assets/acuteresponse_02_gab03_leukocytes_dark.png';
import fig3 from '../../../assets/acuteresponse_03_gab03_two_waves.png';
import fig3Dark from '../../../assets/acuteresponse_03_gab03_two_waves_dark.png';
import fig4 from '../../../assets/acuteresponse_04_gab03_monocyte_subsets.png';
import fig4Dark from '../../../assets/acuteresponse_04_gab03_monocyte_subsets_dark.png';
import fig5 from '../../../assets/acuteresponse_05_gk97_monocyte_maturation.png';
import fig5Dark from '../../../assets/acuteresponse_05_gk97_monocyte_maturation_dark.png';
import fig6 from '../../../assets/acuteresponse_06_gk97_exercise_vs_infection.png';
import fig6Dark from '../../../assets/acuteresponse_06_gk97_exercise_vs_infection_dark.png';
import fig7 from '../../../assets/acuteresponse_07_gab98_nk_cells.png';
import fig7Dark from '../../../assets/acuteresponse_07_gab98_nk_cells_dark.png';
import fig8 from '../../../assets/acuteresponse_08_gab98_cytotoxic_tcells.png';
import fig8Dark from '../../../assets/acuteresponse_08_gab98_cytotoxic_tcells_dark.png';
import fig9 from '../../../assets/acuteresponse_09_gab98_tcell_subsets.png';
import fig9Dark from '../../../assets/acuteresponse_09_gab98_tcell_subsets_dark.png';
...
<Note>
**Learning objectives:**
- Exercise intensity on the IAT scale and the two stimulus classes
- The biphasic leukocytosis and why the phases fuse beyond ≈ 2 h
- The marginal pool as the source, and the subpopulation ranking by amplitude
</Note>
...
<Figure src={fig2} srcDark={fig2Dark} alt="The immediate leukocytosis after a single anaerobic bout">
...
<Figure src={fig3} srcDark={fig3Dark} alt="Two consecutive waves of the immediate leukocytosis">
...
<Figure src={fig4} srcDark={fig4Dark} alt="Regular monocytes demarginate early — premacrophages arrive late">
...
<Note>
**Learning objectives:**
- The five hormonal mediators and the exercise categories that stimulate them
- The pathway catecholamine → β2-receptor → cAMP → LFA-1 avidity → detachment
- The ACTH–cortisol route to delayed neutrophilia, and the four steps of diapedesis
</Note>
...
### 2.4 Figures
<Figure src={fig5} srcDark={fig5Dark} alt="Cell-surface receptor expression during monocyte–macrophage maturation">
...
<Note>
**Learning objectives:**
- Exercise- vs infection-induced leukocytosis: identical counts, opposite meanings
- Monocyte maturation in infection against mobilisation of mature cells in exercise
- CRP and trace elements in the athlete: plasma-volume correction and interpretation
</Note>
...
### 3.4 Figures
<Figure src={fig6} srcDark={fig6Dark} alt="The same neutrophil count means something different">
...
<Note>
**Learning objectives:**
- Criteria of an acute phase response and the training protocols that meet them
- The time-integral of lactic acidosis as the decisive variable, and the ≥ 24 h inflammatory window
- Why routine screening labs cannot detect overtraining
</Note>
