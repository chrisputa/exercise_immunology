...
1. [The Biphasic Immune Cell Response to Acute Dynamic Exercise](#1-the-biphasic-immune-cell-response-to-acute-dynamic-exercise)
   - 1.1 [Phase 1 — Immediate Response (Lymphocytosis)](#11-phase-1--immediate-response-lymphocytosis)
   - 1.2 [Phase 2 — Delayed Immune Response (Lymphopenia)](#12-phase-2--delayed-immune-response-lymphopenia)
2. [Hormonal Regulation](#2-hormonal-regulation)
3. [Intensity Dependence of the Immune Cell Response](#3-intensity-dependence-of-the-immune-cell-response)
4. [Effects of Regular Physical Activity on Immunity](#4-effects-of-regular-physical-activity-on-immunity)
5. [IL-6 as the Prototypical Myokine: Cytokine Context Determines Function](#5-il-6-as-the-prototypical-myokine-cytokine-context-determines-function)
   - 5.1 [Cytokine Context: Immune Response Versus Exercise Response](#51-cytokine-context-immune-response-versus-exercise-response)
   - 5.2 [Quantitative IL-6 Response Kinetics by Exercise Modality](#52-quantitative-il-6-response-kinetics-by-exercise-modality)
   - 5.3 [The IL-6 Axis as Energy Allocator](#53-the-il-6-axis-as-energy-allocator)
   - 5.4 [Mechanistic Distinctions: NF-κB Pathway Activation and IL-1ra as the Critical Discriminator](#54-mechanistic-distinctions-nf-κb-pathway-activation-and-il-1ra-as-the-critical-discriminator)
   - 5.5 [Temporal Dynamics and Health Outcomes](#55-temporal-dynamics-and-health-outcomes)
   - 5.6 [Clinical Implications: Distinguishing Exercise from Infection](#56-clinical-implications-distinguishing-exercise-from-infection)
6. [Meta-Analytic Validation: Quantifying the Exercise-Induced Myokine Response (Ringleb et al. 2026)](#6-meta-analytic-validation-quantifying-the-exercise-induced-myokine-response-ringleb-et-al-2026)
   - 6.1 [Overall Effect Sizes: IL-6 as the Dominant Myokine Response](#61-overall-effect-sizes-il-6-as-the-dominant-myokine-response)
   - 6.2 [Exercise Dose-Response Relationships: IL-6 as Metabolic Sensor](#62-exercise-dose-response-relationships-il-6-as-metabolic-sensor)
   - 6.3 [Exercise Modality Effects: Muscle Mass as Critical Moderator](#63-exercise-modality-effects-muscle-mass-as-critical-moderator)
   - 6.4 [Population-Dependent Heterogeneity: Sex, Training Status, and Fitness](#64-population-dependent-heterogeneity-sex-training-status-and-fitness)
   - 6.5 [Temporal and Sampling Considerations](#65-temporal-and-sampling-considerations)
   - 6.6 [Integration with Kistner Framework and Clinical Translation](#66-integration-with-kistner-framework-and-clinical-translation)
   - 6.7 [Clinical Exercise Prescription Guided by Dose-Response Evidence](#67-clinical-exercise-prescription-guided-by-dose-response-evidence)
   - 6.8 [Disease-Specific Therapeutic Applications](#68-disease-specific-therapeutic-applications)
   - 6.9 [Overtraining and Myokine Monitoring: Red Flags for Excessive Training Load](#69-overtraining-and-myokine-monitoring-red-flags-for-excessive-training-load)
   - 6.10 [Research Gaps and Future Directions](#610-research-gaps-and-future-directions)
7. [The J-Shaped Curve Model](#7-the-j-shaped-curve-model)
8. [References](#references-3)
...
## 1 The Biphasic Immune Cell Response to Acute Dynamic Exercise
...
### 1.1 Phase 1 -- Immediate Response (Lymphocytosis)
...
### 1.2 Phase 2 -- Delayed Immune Response (Lymphopenia)
...
## 3 Intensity Dependence of the Immune Cell Response
...
## 4 Effects of Regular Physical Activity on Immunity
...
## 5 IL-6 as the Prototypical Myokine: Cytokine Context Determines Function
...
### 5.1 Cytokine Context: Immune Response Versus Exercise Response
...
### 5.2 Quantitative IL-6 Response Kinetics by Exercise Modality
...
### 5.4 Mechanistic Distinctions: NF-κB Pathway Activation and IL-1ra as the Critical Discriminator
...
### 5.5 Temporal Dynamics and Health Outcomes
...
### 5.6 Clinical Implications: Distinguishing Exercise from Infection
...
### 6.1 Overall Effect Sizes: IL-6 as the Dominant Myokine Response
...
### 6.2 Exercise Dose-Response Relationships: IL-6 as Metabolic Sensor
...
### 6.3 Exercise Modality Effects: Muscle Mass as Critical Moderator
...
### 6.4 Population-Dependent Heterogeneity: Sex, Training Status, and Fitness
...
### 6.5 Temporal and Sampling Considerations
...
### 6.6 Integration with Kistner Framework and Clinical Translation
...
### 6.7 Clinical Exercise Prescription Guided by Dose-Response Evidence
...
### 6.8 Disease-Specific Therapeutic Applications
...
### 6.9 Overtraining and Myokine Monitoring: Red Flags for Excessive Training Load
...
### 6.10 Research Gaps and Future Directions
