...
1. [Language & Energetics of Exercise](#1-language-and-energetics-of-exercise)
2. [Homeostasis: Acute Regulation](#2-homeostasis-acute-regulation)
3. [Hormesis: Chronic Adaptation & Clinical Edge](#3-hormesis-chronic-adaptation-and-clinical-edge)
4. [Intensity Determination & Diagnostics](#4-intensity-determination-and-diagnostics)
...
**Learning objectives:**
- Distinguish physical activity, exercise, training and sport (Caspersen) and justify why the distinction matters for public-health messaging.
- Decompose TDEE into BMR, RMR, TEF and AEE/NEAT and identify the most modifiable component.
- Select an appropriate BMR/RMR prediction equation for a given population (Harris–Benedict → Cunningham → Ten Haaf & Weijs; FFM vs LBM).
- Use V̇O₂, MET and MET-min to express metabolic strain in comparable units.
...
**Learning objectives:**
- Trace an acute perturbation → correction → recovery loop for heart rate and minute ventilation.
- Explain cardiovascular, respiratory, metabolic and thermoregulatory adjustments as coordinated homeostatic corrections.
- Relate O₂ transport, Fick diffusion and normoxia/hypoxia to why these adjustments are physiologically required.
- Describe EPOC and the fast/slow phases of return to baseline.
...
**Learning objectives:**
- Locate a training dose within the sub-threshold / hormetic / overload zones and predict the adaptive outcome.
- Explain the dual identity of IL-6, ROS and NF-κB as error signal vs adaptive trigger.
- Apply the homeostasis-vs-hormesis contrast (Table 3) as a take-home model.
- Use the dual framework to justify divergent prescriptions for a healthy runner vs a Long-COVID patient, and explain why GET fails in ME/CFS.
...
**Learning objectives:**
- Differentiate T1/T2 threshold concepts across metabolic, gas-exchange and ventilatory models.
- Explain why %V̇O₂max / %HRmax / %HRR / METs under-individualise intensity.
- Apply the ACSM–ESSA 5-level terminology; use RIR for resistance and RPE as an adjunct.
- Select and defend an intensity-anchoring method and interpret HRmax / HRR for a specific athlete or patient.
