...
5. [Behaviour and V̇O₂](#5-behaviour-and-v̇o)
6. [Threshold Concepts](#6-threshold-concepts)
7. [How to Determine and Monitor the Different Exercise Intensities](#7-how-to-determine-and-monitor-the-different-exercise-intensities)
...
<Fragment slot="caption">
Comparison of Estimation Formulas of Basal Metabolic Rate with special relevance for athletic populations (adapted from [17–20]).
