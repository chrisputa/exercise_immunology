...
### 3.1 Short-Term Balancing of Homeostasis
...
#### 3.1.2 Acute Responses to Exercise
...
#### 3.1.3 Recovery and Return to Baseline
...
### 3.2 Homeostasis and Hormesis

#### 3.2.1 From Homeostatic Regulation to Hormetic Adaptation
...
#### 3.2.2 Hormetic Stress Response
...
#### 3.2.3 The Dual Identity of Inflammatory Mediators
...
#### 3.2.4 Molecular Mediators of the Hormetic Response
...
#### 3.2.5 Biphasic Dose-Response and the J-Curve of Immune Function
...
#### 3.2.6 Complementary Temporal Scales
...
#### 3.2.7  Pathological Contexts: ME/CFS, Long COVID, and Post-Exertional Malaise
...
### 3.3 The Biphasic Immune Cell Response to Acute Dynamic Exercise
...
#### 3.3.1 Phase 1 -- Immediate Response (Lymphocytosis)
...
#### 3.3.2 Phase 2 -- Delayed Immune Response (Lymphopenia)
...
### 3.5 Intensity Dependence of the Immune Cell Response
...
### 3.6 Effects of Regular Physical Activity on Immunity
...
### 3.7 IL-6 as the Prototypical Myokine: Cytokine Context Determines Function
...
#### 3.7.1 Cytokine Context: Immune Response Versus Exercise Response
...
#### 3.7.2 Quantitative IL-6 Response Kinetics by Exercise Modality
...
#### 3.7.3 The IL-6 Axis as Energy Allocator
...
#### 3.7.4 Mechanistic Distinctions: NF-κB Pathway Activation and IL-1ra as the Critical Discriminator
...
#### 3.7.5 Temporal Dynamics and Health Outcomes
...
#### 3.7.6 Clinical Implications: Distinguishing Exercise from Infection
...
### 3.8 Meta-Analytic Validation: Quantifying the Exercise-Induced Myokine Response (Ringleb et al. 2026)
...
#### 3.8.1 Overall Effect Sizes: IL-6 as the Dominant Myokine Response
...
#### 3.8.2 Exercise Dose-Response Relationships: IL-6 as Metabolic Sensor
...
#### 3.8.3 Exercise Modality Effects: Muscle Mass as Critical Moderator
...
#### 3.8.4 Population-Dependent Heterogeneity: Sex, Training Status, and Fitness
...
#### 3.8.5 Temporal and Sampling Considerations
...
#### 3.8.6 Integration with Kistner Framework and Clinical Translation
...
#### 3.8.7 Clinical Exercise Prescription Guided by Dose-Response Evidence
...
#### 3.8.8 Disease-Specific Therapeutic Applications
...
#### 3.8.9 Overtraining and Myokine Monitoring: Red Flags for Excessive Training Load
...
#### 3.8.10 Research Gaps and Future Directions
