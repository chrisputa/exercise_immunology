...
import biphasic from '../../../assets/biphasic_01_response.png';
import biphasicDark from '../../../assets/biphasic_01_response_dark.png';
import il6 from '../../../assets/biphasic_02_il6_energy_allocator.png';
import il6Dark from '../../../assets/biphasic_02_il6_energy_allocator_dark.png';
import ringleb from '../../../assets/biphasic_03_ringleb_effect_sizes.png';
import ringlebDark from '../../../assets/biphasic_03_ringleb_effect_sizes_dark.png';
import { Note } from '../../../components/MarginNote/index.js';

## Table of Contents

1. [The Acute Biphasic Response & Its Regulation](#1-the-acute-biphasic-response--its-regulation)
2. [From Acute Bout to Chronic Adaptation: The Myokine Concept](#2-from-acute-bout-to-chronic-adaptation-the-myokine-concept)
3. [Meta-Analytic Validation (Ringleb et al. 2026)](#3-meta-analytic-validation-ringleb-et-al-2026)
4. [Clinical Translation & the J-Curve](#4-clinical-translation--the-j-curve)
...
<Note>
**Learning objectives:**
- The two-phase cell-count curve and its hormonal drivers
- Phase 2 lymphopenia as redistribution and surveillance, not suppression
- The individual anaerobic threshold as the epinephrine breakpoint
</Note>
...
<Note>
**Learning objectives:**
- The myokine concept and skeletal muscle as an endocrine organ
- IL-6 in context: identical concentrations, opposite meanings in exercise and infection
- The two signalling routes: AMPK–PGC-1α–SIRT1 vs NF-κB
</Note>
...
<Note>
**Learning objectives:**
- Myokine effect sizes: IL-6 against the counter-regulatory cytokines
- The IL-6 dose-response (MET·min) as evidence for the energy-sensing model
- Population moderators (sex, training status, fitness, age) and sampling effects
</Note>
...
<Note>
**Learning objectives:**
- Exercise dosing for anti-inflammatory clinical goals
- Disease-specific therapeutic applications and open research gaps
- The J-shaped curve model and the evidence for and against it
</Note>
