...
**Abb. 1** (Kindermann, adapted from Ergonizer Software, Freiburg) shows a representative lactate performance curve derived from **five serial cycle ergometer tests** in a single subject (starting at 100 W, incremental steps of 20 W every 3 minutes). Two physiologically distinct thresholds are identified:
