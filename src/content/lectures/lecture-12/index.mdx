...
description: Synthesises the preceding lectures into a framework for the *standardised evaluation of symptoms and signs* of both exercise-induced and infection-based immunological stress regulation — providing validated assessment instruments, diagnostic algorithms, and practical decision tools for clinical and field application.
draft: false
---
